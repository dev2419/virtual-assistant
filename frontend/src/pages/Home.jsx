...
<div className='hidden lg:flex flex-col absolute top-[220px] right-[20px] w-[300px] h-[400px] bg-[#00000066] backdrop-blur-md p-4 rounded-lg overflow-y-auto'>
  <h1 className='text-white font-semibold text-[19px] mb-2'>History</h1>
  {userData.history?.map((his, index) => (
    <div key={index} className='text-gray-200 text-[16px] mb-1'>{his}</div>
  ))}
</div>
